...
@SpringBootApplication @EnableDiscoveryClient public class IngredientesServiceApplication {
public static void main(String[] args){SpringApplication.run(IngredientesServiceApplication.class,args);}
}